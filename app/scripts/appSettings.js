...
angular.module('SpringSettings', ['angularMoment', 'openfb'])
  .factory('appSettings', function(OpenFB, $location) {
    ...
    return {
      fbKey: '803338023047050',
      fbCallbackFile: 'http://localhost:8100/oauthcallback.html',
      fbServerCallbackFile: 'http://rapid.qualitance.com/oauthcallback.html',

      loginPermissions: 'public_profile,email,read_stream,publish_stream,user_about_me,user_tagged_places',
      userFields: 'about,picture,name,cover,bio,email, tagged_places',
